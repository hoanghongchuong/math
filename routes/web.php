...
Route::get('tai-lieu',['as'=>'getProduct', 'uses'=>'IndexController@getProduct']);
Route::get('tai-lieu/{alias}.html','IndexController@getProductDetail')->name('detailProduct');
Route::get('tai-lieu/{id}',['as'=>'getProductList', 'uses'=>'IndexController@getProductList']);
Route::get('danh-muc/{alias}', 'IndexController@getProductByCate')->name('detailCategory');

Route::get('read/file/{id}', 'IndexController@readFileDocument')->name('read.file');
Route::get('count/download', 'IndexController@countDownload')->name('count.download');
