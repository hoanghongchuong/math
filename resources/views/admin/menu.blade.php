<aside class="main-sidebar">
    ...
    <section class="sidebar">
      <ul class="sidebar-menu">
        ...
        <li class="treeview ">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Quản lý tài liệu</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li><a href="backend/productcate"><i class="fa fa-circle-o"></i> <span>Danh mục</span></a></li>
            <li><a href="backend/product"><i class="fa fa-circle-o"></i> <span>Danh sách</span></a></li>           
          </ul>
        </li>
        ...
        <li><a href="backend/news?type=baiviet"><i class="fa fa-circle-o"></i> <span>Bài viết</span></a></li>
