	                  	...
	                  	<div class="tab-pane active" id="tab_1">
	                  		<div class="row">
		                  		<div class="col-md-6 col-xs-12">
									...
									<div class="form-group">
										<label for="file">File tài liệu: {{ $data->document }}</label>
								     	<input type="file" name="document" >
										<input type="hidden" name="document_current" value="{{ $data->document }}">

								    	<p class="help-block">File phải định dạng .pdf và dung lượng file không vượt quá 10MB</p>
							    		@if($errors->first('document'))
								      	<label class="control-label" for="inputError" style="color: red"><i class="fa fa-times-circle-o"></i> {!! $errors->first('document'); !!}</label>
								      	@endif
									</div>
									<!-- <div class="form-group">
